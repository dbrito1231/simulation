---
name: civilization-cycle-morning
description: >-
  Run the morning slot of the civilization emergence compressed cycle: stop the
  local sim server, audit the night soak logs, hot-fix or implement the next
  batch, review commits, restart the server. Use when the user asks to run the
  morning cycle, morning audit, Part 8 morning slot, or manually check the
  overnight soak.
disable-model-invocation: true
---

# Civilization cycle — morning slot

Manual run of the **morning** compressed twice-daily cycle for the AI village simulation.
...
Commit message format: `Cycle N.morning: <one-line verdict summary>`
...
Plain language, coffee-readable:

- Per-flag verdicts and key numbers
- What changed (commits, hot-fixes)
- What the **evening** slot should do next

...
//   mid   — dest 24×24 (procedural scale 2 → ~32 px fallback): fox, owl, turtle,
...
const WILDLIFE_SHEET_FRAMES = {
  ...
  fox: { sx: 64, sy: 0, sw: 16, sh: 16, destW: 24, destH: 24 },
  owl: {
    stand: { sx: 80, sy: 0, sw: 16, sh: 16, destW: 24, destH: 24 },
    alt: { sx: 96, sy: 0, sw: 16, sh: 16, destW: 24, destH: 24 },
  },
  turtle: { sx: 112, sy: 0, sw: 16, sh: 16, destW: 24, destH: 24 },
  rabbit: {
    stand: { sx: 0, sy: 16, sw: 16, sh: 16, destW: 24, destH: 24 },
    alt: { sx: 16, sy: 16, sw: 16, sh: 16, destW: 24, destH: 24 },
  },
  chicken: {
    stand: { sx: 32, sy: 16, sw: 16, sh: 16, destW: 24, destH: 24 },
    alt: { sx: 48, sy: 16, sw: 16, sh: 16, destW: 24, destH: 24 },
  },
  gull: {
    stand: { sx: 64, sy: 16, sw: 16, sh: 16, destW: 24, destH: 24 },
    alt: { sx: 80, sy: 16, sw: 16, sh: 16, destW: 24, destH: 24 },
  },
  bird: {
    stand: { sx: 96, sy: 16, sw: 16, sh: 16, destW: 24, destH: 24 },
    alt: { sx: 112, sy: 16, sw: 16, sh: 16, destW: 24, destH: 24 },
  },

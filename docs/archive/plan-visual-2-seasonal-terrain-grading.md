...
> **Superseded (2026-07-31):** `VISUAL_SEASONAL_TERRAIN_ENABLED` removed; v2 seasonal
> terrain is the permanent viewer default. See `specs/11-viewer.md` § Atmosphere rendering.
